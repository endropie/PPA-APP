    ...
    return {
      ...
      TABLE:{
        ...
        columns: [
          ...
          { name: 'counter_delivered', label: 'Delivery', align: 'center', field: (row) => row.delivery_counter.delivered, sortable: true},
          { name: 'counter_confirmed', label: 'Confirm', align: 'center', field: (row) => row.delivery_counter.confirmed, sortable: true},
          { name: 'counter_invoiced', label: 'Invoiced', align: 'center', field: (row) => row.delivery_counter.invoiced, sortable: true},
