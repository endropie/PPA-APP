    ...
    return {
      ...
      TABLE: {
        ...
        columns: [
          ...
          { name: 'cost', field: 'cost', label: this.$tc('label.cost'), align: 'left', sortable: true },
          { name: 'customer_names', field: 'customer_names', label: this.$tc('general.customer'), align: 'left', sortable: false },
